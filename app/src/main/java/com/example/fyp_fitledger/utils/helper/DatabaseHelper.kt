package com.example.fyp_fitledger.utils.helper
...
import com.example.fyp_fitledger.data.model.FoodCategory
import com.example.fyp_fitledger.data.model.FoodNutrient
import com.example.fyp_fitledger.data.model.FoodPortion
import com.example.fyp_fitledger.data.model.FoodPortionJson
...
class DatabaseHelper(private val context: Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    ...
    fun getFoodByName(foodName: String): FoodModel? {
        val db = readableDatabase
        val cursor = db.query(
            "Food", // The table name
